public class RandomNumbers {
    public static void main(String[] args) {
        ...
        // con números aleatorios del 0 al 99, a través de un bucle anidado
        // (Si no te suenan estos conceptos, ¡búscalos!)
        System.out.println("Matriz de 100 x 10 con números aleatorios del 0 al 99: \n");
